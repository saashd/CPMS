...
class UserDetails extends React.Component {
    ...
    componentDidMount() {
        ...
        let courses = this.props.courses ? [...this.props.courses] : null;
        let semesters = this.props.semesters ? [...this.props.semesters] : null;
        let organizations = this.props.organizations ? [...this.props.organizations] : null;
        ...
        Promise.all(promises).then(() => {
            user.courseId = courses.filter(obj => {
                return obj.id === user.courseId
            })[0];
            user.semesterId = semesters.filter(obj => {
                return obj.id === user.semesterId
            })[0];
            user.organizationId = organizations.filter(obj => {
