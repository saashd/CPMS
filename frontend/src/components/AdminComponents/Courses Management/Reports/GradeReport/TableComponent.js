...
class TableComponent extends React.Component {
    ...
    columns = [
        ...
        {
            title: 'Final Grade Proj. Part 1',
            field: 'gradeStage1',
        },
        {
            title: 'Final Grade Proj. Part 2',
            field: 'gradeStage2',
        },
        {
            title: 'Final Grade Proj. Part 3',
            field: 'gradeStage3',
        },
        {
            title: 'Final Grade Proj. Part 4',
            field: 'gradeStage4',
        },
    ];

    /**
     * Function that renders some of data's properties to sting and adds as new properties, for future display in material-table
     * @param data
     * @return {*}
     */
    renderData = (data) => {
        for (let obj of data) {
            if (obj.organizationObj) {
                obj.organizationName = obj.organizationObj.name;
            } else {
                obj.organizationName = "";

            }
            if (obj.industrialAdvisorObj) {
                obj.industrialAdvisorName = obj.industrialAdvisorObj.engFirstName + ' ' + obj.industrialAdvisorObj.engLastName;
            } else {
                obj.industrialAdvisorName = "";

            }
            if (obj.academicAdvisorObj) {
                obj.academicAdvisorName = obj.academicAdvisorObj.engFirstName + ' ' + obj.academicAdvisorObj.engLastName;
            } else {
                obj.academicAdvisorName = "";

            }
            obj.studentName = obj.engFirstName + ' ' + obj.engLastName;
        }
        return data;
    };
